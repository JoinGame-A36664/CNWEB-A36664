...
class TestItem extends Component {
          ...
          onChangePage = (event) => {
                    ...
                    if ((this.state.currentPage === 0 && name === "backward") || (this.state.currentPage === this.state.totalCount && name === "forward")) {

                    } else {
                              this.setState({
                                        currentPage: name === "forward" ? this.state.currentPage + 1 ,
                                                                                          ...
                                                                                          <div className="col-md-10 col-lg-10">
                                                                                                    <div className="border">
                                                                                                              ...
                                                                                                              {this.state.question.map(item => (
                                                                                                                        ...
                                                                                                                        <Question data={item} id={this.state.currentPage}></Question>
                                                                                                              ))}
