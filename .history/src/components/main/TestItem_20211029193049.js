...
class TestItem extends Component {
          ...
          render() {
                    ...
                    if (this.props.isFinish === false) {
                              buttonStart = <button className="btn btn-primary" onClick={this.LoadQuiz} >Start</button>
                    } else {
                              buttonStart = <button className="btn btn-primary" disabled={true}>Finish</button>
                    }
