                                                                                                    ...
                                                                                                    <div className="border">
                                                                                                              <div className="question bg-white p-3 border-bottom">
                                                                                                                        <div className="d-flex flex-row justify-content-between align-items-center mcq">
                                                                                                                                  <h4>MCQ Quiz   {<Countdown onStop={this.onTick} onComplete={this.onComplete}  renderer={renderer} date={Date.now() + 6000} />}</h4><span>({this.state.currentPage} of {this.state.totalCount})</span>
                                                                                                                        </div>
                                                                                                              </div>
