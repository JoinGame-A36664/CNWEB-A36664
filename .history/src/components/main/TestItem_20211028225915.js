...
class TestItem extends Component {
          ...
          onFinish = () => {
                    ...
                    console.log(this.state.question.category);
                    var data = {
                              name: this.state.question.category,
                              point: this.state.answers,
                              time: this.state.question.length,
                              diff:2,
                              past: this.state.answers > Math.floor(this.state.question.length % this.state.answers) ? true : false,

                    }
                    apiCaller('task', 'POST', data).then(res => {
