...
class TestItem extends Component {
          ...
          onFinish = async () => {
                    ...
                    console.log(this.state.time, "old");
               
                    console.log(time, 'cac');
                    await this.setState({
                              time: this.state.time === minute ? date.getSeconds() : Math.abs(minute - this.state.time) * 60
                    })
                    console.log(this.state.time, "new");
                    // var data = {
