...
class TestItem extends Component {
          ...
          onEndCountdouwn = (time) => {
                  
                    this.setState({
                              time:this.state.time-time.seconds
                    })
                    console.log("xong", this.state.time);
          }
          render() {
                    let button;
                                                                                                    ...
                                                                                                    <div className="border">
                                                                                                              <div className="question bg-white p-3 border-bottom">
                                                                                                                        <div className="d-flex flex-row justify-content-between align-items-center mcq">
                                                                                                                                  <h4>MCQ Quiz   {<Countdown onComplete={this.onComplete} onTick={this.onEndCountdouwn} renderer={renderer} date={Date.now() + 6000} />}</h4><span>({this.state.currentPage} of {this.state.totalCount})</span>
                                                                                                                        </div>
                                                                                                              </div>
