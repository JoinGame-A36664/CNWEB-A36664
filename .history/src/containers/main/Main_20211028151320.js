...
class Main extends Component {
          ...
          receivedData() {
                    apiCaller('task', 'GET', null).then(res => {
                          ...
                          const slice = linq.from(data).skip(this.state.pageSize*(this.state.currentPage-1)).take(this.state.pageSize)
                              this.setState({
                                        testData: slice,
          ...
          onChangePage(pageNumber) {
                    ...
                    const offset = pageNumber===1?0: pageNumber * this.state.pageSize;
